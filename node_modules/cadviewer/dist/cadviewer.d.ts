declare module 'cadviewer' {
    ...
    export function cvjs_lastSavedView(f_div: string): boolean;
    ...
    export function cvjs_suppressActionLooper(flag: boolean): void;
    ...
    export function cvjs_setDefaultSpaceObjectColor(colorObject: any): void;
    export function cvjs_setDefaulSpaceObjectColor(colorObject: any): void;
    export function cvjs_getDefaultSpaceObjectColor(): any;
    export function cvjs_getCurrentIconMenuPage(): number;
    ...
    export function cvjs_setUpPattern_0degree_crosshatch_standard(colorHex: any, patternOpacity: any): void;
    export function cvjs_setUpPattern_0degree_crosshatch_fine(colorHex: any, patternOpacity: any): void;
    export function cvjs_setRedlineStrokeDashArray(redlineId: any, graphicalPattern:any): void;
    ...
    export function cvjs_CompareDrawings_DisplayNameAlias(f_div: string, drawing1: string, drawing2: string, displayname1: string, displayname2: string ): void;
    ...
    export function cvjs_setInsertImageObjectsAbsolutePath(path: string, serverPath: string, dynamicPathFlag: boolean): void;
    ...
    export function cvjs_setSpaceObjectsAbsolutePath(path: string, serverPath: string,dynamicPathFlag: boolean): void;
    ...
    export function cvjs_addSpaceObjectRectangle(f_div: string, ID: string, type: string, name: string, layer: string): void;
    export function cvjs_addSpaceObjectPolygon(f_div: string, ID: string, type: string, name: string, layer: string): void;
    ...
    export function cvjs_zoomHere_PopUp(): void;
    ...
    export function cvjs_SVG_x_toScreen(x: number): number;
    export function cvjs_SVG_y_toScreen(y: number): number;
    ...
    export function cvjs_getRedlineStyles(redid: any): any;
    ...
    export function cvjs_enablePolygonControlPoints(flag: boolean): void;
    ...
    export function cvjs_reactivateZoomImageWallpaper(): void;
